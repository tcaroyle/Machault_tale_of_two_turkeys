...
##Create main map 
  ...
  annotate("text", x = -64.80, y = 48.1, label = "Chaleur Bay", 
           size = 4, color = "black", fontface = "bold", angle=30) +
  annotate("text", x = -68.4, y = 48.7, label = "St. Lawrence River", 
           size = 4, color = "black", fontface = "bold", angle=39) +
  ...
  annotation_north_arrow(location = "br", which_north = "true", 
                         pad_x = unit(0.47, "in"), pad_y = unit(0.2, "in"),
